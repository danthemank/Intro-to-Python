...
# For this project, youll need to set the min and max number that your dice can produce.
# For the average die, that means a minimum of 1 and a maximum of 6.
# Youll also want a function that randomly grabs a number within that range and prints it.